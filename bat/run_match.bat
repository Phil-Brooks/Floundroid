...
rem @echo off
cutechess-cli.exe -engine name=Floundroid cmd=Floundroid.exe proto=uci stderr=err.txt -engine name=TSCP cmd=tscp181.exe proto=xboard -each tc=30 -openings file=gm2001.bin -games 100 -repeat -concurrency 4 -pgnout baseline_results.pgn>log.txt 
